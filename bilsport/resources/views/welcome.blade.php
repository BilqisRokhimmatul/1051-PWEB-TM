...
<head>
    ...
    <style type="text/tailwindcss">
        /* Mengubah deteksi dark mode v4 menjadi berbasis class (.dark) */
    ...
    <script>
        ...
        // Mengecek preferensi tema saat halaman pertama kali dimuat
...
<body class="bg-[#FFFCEB] dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 transition-colors duration-200 antialiased">
    ...
    <!-- TOP NAVBAR (Putih Transparan & Blur Efek) -->
    <nav class="sticky top-0 z-50 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md border-b border-gray-200/50 dark:border-zinc-800/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center gap-4">
                ...
                <!-- SISI KIRI: Logo BILSPORT (Sesuai image_0c0c61.png) -->
                <!-- SISI KIRI: Logo Gambar BILSPORT (Update Berdasarkan Aset Kamu) -->
                <div class="flex items-center gap-3 shrink-0">
                    <a href="#" class="flex items-center gap-2 group">
                        <!-- Panggil gambar logo dari folder public/images/ -->
                ...
                <!-- SISI TENGAH: Fitur Navigasi Umum -->
                ...
                <!-- SISI KANAN: Login/Dashboard & Preferensi Terang/Gelap -->
   ...
   <!-- BANNER HERO PREMIUM + DASHBOARD STATISTIK (Ref: image_0bfd23.png & image_0b8fc6.png) -->
    <header class="relative text-white pt-36 pb-20 px-4 text-center overflow-hidden transition-colors duration-200" 
        ...
        <!-- Pembungkus gradient dinamis untuk mencocokkan latar belakang bawah -->
        ...
        <div class="max-w-6xl mx-auto relative z-10">
            ...
            <!-- Search Bar Efek Kaca Transparan -->
            <div class="mt-12 max-w-2xl mx-auto px-4">
                <form action="#" method="GET" class="flex gap-2 bg-white/25 dark:bg-zinc-800/40 backdrop-blur-md border border-white/30 dark:border-zinc-700/50 rounded-2xl p-2 shadow-2xl transition-all duration-300 focus-within:border-white/60 focus-within:bg-white/30">
                    
                    <input type="text" name="search" placeholder="Cari lapangan kesukaanmu..." 
                        class="w-full px-4 py-3.5 text-white placeholder-gray-200 focus:outline-none text-sm font-medium bg-transparent">
                    
                    <button type="submit" class="bg-[#581c24] hover:bg-[#42141a] text-white font-semibold px-7 py-3.5 rounded-xl text-sm transition-all shadow-md active:scale-95 shrink-0">
                        Cari Lapangan
                    </button>
                </form>
            </div>

            <!-- SECTION BARU: MODERNDASHBOARD CARDS (Transformasi dari image_0b8fc6.png) -->
            <div class="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4 px-4 text-left">
                ...
                <div class="bg-white/5 dark:bg-black/10 backdrop-blur-md border border-white/10 dark:border-zinc-800/50 p-5 rounded-2xl shadow-xl hover:border-white/20 transition-all group">
                    ...
                    <div class="flex items-baseline gap-2 mt-2">
                        ...
                        <span class="text-xs text-amber-400 font-medium flex items-center gap-0.5">
                            ⭐ 4.9/5
                        </span>
                    </div>
                </div>
            ...
            <!-- GRAPH SECTION: GRAFIK PEMESANAN MINGGUAN (Ref: Bagian bawah image_0b8fc6.png) -->
            <div class="mt-8 px-4">
                <div class="bg-white/5 dark:bg-black/20 backdrop-blur-lg border border-white/10 dark:border-zinc-800/60 rounded-3xl p-6 shadow-2xl text-left">
                    ...
                    <!-- Container Chart (Ref: image_0b88be.png) -->
    ...
    <!-- Script Chart.js & Inisialisasi Visual Grafik -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Membuat gradasi warna mewah di bawah garis grafik
            const gradientBg = ctx.createLinearGradient(0, 0, 0, 250);
            gradientBg.addColorStop(0, 'rgba(220, 38, 38, 0.4)'); // Merah maroon transparan di atas
            gradientBg.addColorStop(1, 'rgba(220, 38, 38, 0.0)'); // Memudar bersih di bawah
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [15, 28, 22, 35, 45, 68, 55], // Data representatif grafik mingguan
                        borderColor: '#ef4444', // Warna garis merah terang modern
                        borderWidth: 3.5,
                        ...
                        tension: 0.4 // Membuat lekukan garis melengkung smooth & modern
                    }]
                },
                options: {
                    responsive: true,
                    ...
                    plugins: {
                        legend: {
                            display: false // Menyembunyikan label kotak atas agar minimalis
                        },
                        tooltip: {
                    ...
                    scales: {
                        x: {
                            grid: {
                                display: false // Menghilangkan garis vertikal biar bersih
                            },
                            ticks: {
                                color: '#2d0c10', // Warna teks hari (zinc terang) agar kontras dengan latar belakang
                                font: {
                                    size: 12,
                                    weight: '500'
                                }
                        ...
                        y: {
                            ...
                            border: {
                                dash: [5, 5] // Efek garis putus-putus modern
                            },
                            ticks: {
                                color: '#a1a1aa',
                                font: {
    ...
    <section id="tentang" class="py-16 bg-transparent">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <span class="text-xs font-bold tracking-widest text-[#581c24] dark:text-red-400 uppercase">
                Fitur Utama
            </span>
            <h2 class="mt-2 text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl tracking-tight">
                Pengalaman Booking Lapangan yang Berbeda!
            </h2>
            <p class="mt-3 max-w-2xl mx-auto text-sm text-gray-500 dark:text-zinc-400">
                Platform BILSPORT dirancang khusus untuk memberikan kemudahan akses olahraga tanpa ribet bagi masyarakat Indonesi.
            </p>

            <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                
                <div class="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 text-left group">
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-zinc-400 leading-relaxed">
                        Temukan lapangan futsal, badminton, atau basket secara cepat berdasarkan filter kategori olahraga favoritmu.
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 text-left group">
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-zinc-400 leading-relaxed">
                        Lakukan pemesanan kapan saja dan dari mana saja tanpa perlu repot datang langsung ke lokasi GOR atau menunggu balasan admin WA.
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 text-left group">
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-zinc-400 leading-relaxed">
                        Sistem kalender interaktif mendeteksi jam kosong secara akurat, mencegah terjadinya bentrokan jadwal booking antar tim.
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 text-left group">
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-zinc-400 leading-relaxed">
                        Dapatkan bukti e-tiket booking secara instan setelah pembayaran selesai untuk langsung ditunjukkan kepada penjaga lapangan.
                    </p>
                </div>
    ...
    <!-- UTAMA: Daftar Lapangan & Filter Sidebar (Sesuai Layout image_0c0c61.png) -->
    <main id="lapangan" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div class="text-left">
                    <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white tracking-tight">
                            Eksplorasi Lapangan Terbaik
                        </h2>
                    </div>
                    <p class="mt-2 text-sm text-gray-500 dark:text-zinc-400 font-medium">
                        Pilih cabang olahraga, cek jadwal yang tersedia, dan lakukan reservasi instan secara nasional.
                    </p>
                </div>
        ...
        <!-- KONTEN DAFTAR LAPANGAN FULL WIDTH (Tanpa Filter - Ref: Lebih Lega & Simetris) -->
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            
            <!-- Area Grid Lapangan Langsung Memenuhi Layar (Bisa muat sampai 4 kolom di layar besar) -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white dark:bg-zinc-950 rounded-2xl border border-gray-100 dark:border-zinc-800/80 shadow-xs overflow-hidden hover:shadow-lg transition duration-300 group flex flex-col justify-between">
                    <div>
                        <!-- Gambar Lapangan (Dinamis dari input Admin) -->
        ...
        <!-- SECTION: FITUR SESI DATA KUNJUNGAN (Ref: Murni Kunjungan Web - image_07f10f.png) -->
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white dark:bg-zinc-950 border border-gray-100 dark:border-zinc-800/80 rounded-3xl p-6 md:p-8 shadow-xs relative overflow-hidden">
            ...
            <div class="text-left mb-6">
                <span class="text-[10px] font-black tracking-widest text-[#581c24] dark:text-red-400 uppercase">
                    Fitur Sesi
                </span>
                ...
                <p class="text-xs text-gray-400 dark:text-zinc-500 mt-0.5">
                    Informasi ini disimpan secara lokal di dalam enkripsi enkapsulasi Laravel Session.
                </p>
            </div>

            <!-- Grid 3 Kolom Info Sesi -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                
                <!-- Card 1: Jumlah Kunjungan ke Web -->
                <div class="flex items-center gap-4 bg-gray-50/50 dark:bg-zinc-900/40 border border-gray-100 dark:border-zinc-800/50 p-4 rounded-2xl">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-black text-gray-950 dark:text-white mt-0.5">
                            {{ $jumlahKunjungan }} x
                        </p>
                    </div>
                </div>

                <!-- Card 2: Akses Pertama Kali -->
                <div class="flex items-center gap-4 bg-gray-50/50 dark:bg-zinc-900/40 border border-gray-100 dark:border-zinc-800/50 p-4 rounded-2xl">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-semibold text-gray-800 dark:text-zinc-300 mt-1">
                            {{ Session::get('kunjungan_pertama') }}
                        </p>
                    </div>
                </div>

                <!-- Card 3: Akses Terakhir Terdeteksi -->
                <div class="flex items-center gap-4 bg-gray-50/50 dark:bg-zinc-900/40 border border-gray-100 dark:border-zinc-800/50 p-4 rounded-2xl">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-semibold text-gray-800 dark:text-zinc-300 mt-1">
                            {{ Session::get('kunjungan_terakhir') }}
                        </p>
                    </div>
                </div>
